<template>
  ...
  <form
    ...
    class="max-w-lg w-full mx-auto p-6 bg-white rounded-lg shadow-md"
  >
    ...
    <div class="mb-4">
      ...
      <p v-if="errors.queryType" class="text-red-500 text-sm mt-1">
    ...
    <div class="mb-4">
      ...
      <p v-if="errors.consent" class="text-red-500 text-sm mt-1">
    ...
    <button
      type="submit"
      class="w-full bg-green-700 text-white py-2 rounded-md"
    >
      Submit
    </button>
  </form>
